...
namespace Chess
{
	...
	public class Game1 : Game
	{
		...
		protected override void LoadContent()
		{
            ...
            bPawn = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackPawn");
            bRook = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackRook");
            bHorse = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackHorse");
            bBishop = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackBishop");
            bQueen = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackQueen");
            bKing = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - BlackKing");
            wPawn = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhitePawn");
            wRook = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhiteRook");
            wHorse = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhiteHorse");
            wBishop = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhiteBishop");
            wQueen = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhiteQueen");
            wKing = this.Content.Load<Texture2D>("yuttapichai kerdcharoen - WhiteKing");
		}
		...
		protected override void Update(GameTime gameTime)
		{
            ...
            int x = currentState.X / 75; int j = x;
            int y = currentState.Y / 75; int i = y;
