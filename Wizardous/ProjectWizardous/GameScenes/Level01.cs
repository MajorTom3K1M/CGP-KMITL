...
namespace ProjectWizardous
{
    class Level01 : GameScene
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //Background Object
            spriteBatch.Draw(levelParallax, new Rectangle(0, 0, levelParallax.Width, levelParallax.Height), null, new Color(Color.White, curParallax), 0f, Vector2.Zero, SpriteEffects.None, 1f);
            spriteBatch.Draw(levelBack, new Rectangle(0, 0, levelBack.Width, levelBack.Height), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 1f);
            ...
            //Mask Object
            spriteBatch.Draw(levelFore, new Rectangle(0, 0, levelBase.Width, levelBase.Height), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.9f);
            ...
            spriteBatch.Draw(levelObject, new Rectangle(0, 0, levelParallax.Width, levelParallax.Height), null, Color.White, 0f, Vector2.Zero, SpriteEffects.None, 0.5f);
