...
namespace ProjectWizardous {
    class Enemy2GraphicsComponent : GraphicsComponent {
        ...
        public Enemy2GraphicsComponent(GameScene currentScene) : base(currentScene) {
            enemyTexture = currentScene.SceneManager.Content.Load<Texture2D>("Images/knight");
            _animations = new Dictionary<string, Animation>()
             {
                                { "Idle", new Animation(enemyTexture, new Rectangle(0, 0, 64, 32), 1) }
             };
